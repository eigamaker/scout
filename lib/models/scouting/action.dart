...
class Action {
  ...
  static const Map<ActionType, Action> actions = {
    ...
    ActionType.gameWatch: Action(
      ...
      cost: 50000,
      prerequisite: '試合週',
      obtainableInfo: ['技術面・フィジカル面能力値', '高能力値選手発掘'],
      baseSuccessRate: 0.55,
      primarySkill: ScoutSkill.observation,
      skillCoefficient: 0.04,
      intuitionEffect: '重要な瞬間を捉える（レギュラーのみ）',
    ),
    ActionType.scrimmage: Action(
      ...
      cost: 30000,
      prerequisite: '試合情報',
      obtainableInfo: ['技術面能力値', '高能力値選手発掘'],
      baseSuccessRate: 0.50,
      primarySkill: ScoutSkill.observation,
      skillCoefficient: 0.04,
      intuitionEffect: '隠れた実力発見（レギュラーのみ）',
    ),
